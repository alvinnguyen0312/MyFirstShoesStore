    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInMgr.PasswordSignInAsync(model.Email, model.Password, isPersistent: false,
                ...
                if (result.Succeeded)
                {
                    ...
                    if (currentUser != null)
                    {
                        ...
                        HttpContext.Session.SetString(SessionVariables.Message, "Welcome " + currentUser.Firstname + " " +
